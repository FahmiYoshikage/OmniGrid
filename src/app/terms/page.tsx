        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl sm:p-8">
          ...
          <div className="pt-8">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-300">
              Effective date: May 26, 2026. These Terms of Service govern your access to and use of {BRAND_NAME} and any related features, pages, APIs, and integrations made available through the service.
            </p>
          </div>
