        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl sm:p-8">
          ...
          <div className="pt-8">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-300">
              Effective date: May 26, 2026. This Privacy Policy explains how {BRAND_NAME} collects, uses, stores, and protects information when you access the service, including when you sign in with Google OAuth, GitHub OAuth, or email magic links.
            </p>
          </div>

          <div className="mt-10 space-y-8">
            {sections.map((section) => (
              <section key={section.title} className="rounded-3xl border border-white/10 bg-black/20 p-6">
