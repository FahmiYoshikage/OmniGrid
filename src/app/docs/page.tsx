            ...
            <div className="mx-auto flex max-w-5xl flex-col gap-10">
                <header className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl sm:p-8">
                    ...
                    <div className="pt-8">
                        <h1 className="text-3xl font-black tracking-tight sm:text-4xl">
                            OmniGrid operator documentation
                        </h1>
                        <p className="mt-4 text-sm leading-7 text-slate-300">
                            Everything you need to bootstrap servers, connect to
                            omnigrid-net, and operate a Zero Trust fleet. This
                            guide focuses on production-ready workflow for
                            homelabs, VPS fleets, and private networks.
                        </p>
                    </div>
                </header>
                ...
                >
                    ...
                    <p className="mt-3 text-sm leading-7 text-slate-300">
                        This bootstrap script turns a fresh Linux host into the
                        OmniGrid standard. It installs Docker, joins the
                        external network{' '}
                        <span className="text-cyan-200">omnigrid-net</span>, and
                        prepares the host for managed workloads.
                    </p>
                    <div className="mt-4 rounded-2xl border border-white/10 bg-black/50 p-4 font-mono text-xs text-cyan-100">
                        {BOOTSTRAP_CMD}
                    </div>
                    <p className="mt-3 text-xs text-slate-400">
                        Run as root or with sudo. Review the script before
                        executing in production environments.
                    </p>
                </section>
                ...
                >
                    ...
                    <p className="mt-3 text-sm leading-7 text-slate-300">
                        OmniGrid supports GitHub OAuth, Google OAuth, and email
                        magic links. Configure at least one provider in your{' '}
                        <span className="text-cyan-200">.env.production</span>{' '}
                        and keep{' '}
                        <span className="text-cyan-200">
                            OMNIGRID_PUBLIC_URL
                        </span>{' '}
                        aligned with the public origin.
                    </p>
                    <div className="mt-4 grid gap-3 md:grid-cols-2">
                        <InfoCard
                            title="GitHub OAuth"
                            body="Set the callback to /api/auth/github/callback."
                        />
                        <InfoCard
                            title="Google OAuth"
                            body="Set the callback to /api/auth/google/callback."
                        />
                        <InfoCard
                            title="Email magic links"
                            body="Provide GMAIL_SMTP_USER + GMAIL_SMTP_APP_PASSWORD."
                        />
                        <InfoCard
                            title="Workspace scope"
                            body="Integration secrets are stored per workspace, encrypted at rest."
                        />
                    </div>
                </section>
                ...
                >
                    ...
                    <p className="mt-3 text-sm leading-7 text-slate-300">
                        Publish internal apps with Cloudflare Zero Trust and
                        monitor tunnels, Access apps, and DNS from OmniGrid. Use
                        the Settings page to store Cloudflare credentials per
                        workspace.
                    </p>
                    <ul className="mt-4 space-y-2 text-sm text-slate-300">
                        <li>
                            1. Save Cloudflare Account ID, Tunnel Token, and API
                            token.
                        </li>
                        <li>
                            2. Run cloudflared in your infrastructure with
                            omnigrid-net access.
                        </li>
                        <li>
                            3. Publish hostnames from the Tunnel dashboard in
                            OmniGrid.
                        </li>
                    </ul>
                </section>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            <h3 className="text-lg font-semibold">
                                Need the full product guide?
                            </h3>
                            <p className="mt-1 text-sm text-slate-300">
                                Check the README for deeper architecture and
                                deployment notes.
                            </p>
                        </div>
                        <Link
