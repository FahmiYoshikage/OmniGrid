...
const FEATURES = [
    {
        ...
        description:
            'Open many servers in tabs, keep sessions alive, and jump back without reconnecting.',
    },
    {
        icon: KeyRound,
        title: 'Credential vault',
        description:
            'Reusable password and private-key profiles encrypted with AES-256-GCM.',
    },
    {
        icon: Network,
        title: 'Topology view',
        description:
            'See Tailscale devices and local inventory in one operational map.',
    },
];
                ...
                <div className="grid flex-1 items-center gap-12 py-16 lg:grid-cols-[1.05fr_0.95fr]">
                    <div>
                        ...
                        <h1 className="max-w-4xl text-5xl font-black tracking-tight md:text-7xl">
                            Operate every node from one encrypted command
                            center.
                        </h1>
                        <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                            OmniGrid Network Architecture brings SSH tabs,
                            topology, credentials, and operational context into
                            a polished dashboard built for homelabs, VPS fleets,
                ...
                <section className="grid gap-6 pb-14 lg:grid-cols-[1.05fr_0.95fr]">
                    <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
                        ...
                        <h2 className="text-3xl font-black tracking-tight">
                            Full operator docs are now live.
                        </h2>
                        <p className="mt-3 text-sm leading-7 text-slate-300">
                            Learn the OmniGrid Network Architecture standard,
                            workspace-scoped integrations, and Zero Trust
                            deployment flows. Everything from first boot to
                            Cloudflare Tunnel publishing is covered in one
                            place.
                        </p>
                    ...
                    <div className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-6 shadow-2xl shadow-cyan-950/40">
                        ...
                        <p className="mt-2 text-sm text-slate-300">
                            Turn any Linux host into the OmniGrid Network
                            Architecture standard in seconds.
                        </p>
                        <div className="mt-4 rounded-2xl border border-white/10 bg-black/40 p-4 font-mono text-xs text-cyan-100">
                            curl -fsSL
                            https://gist.githubusercontent.com/FahmiYoshikage/38fbbbfe4ab544bb16e9844efec64e51/raw/ce59bb410f50f0f13096068de5d77695c1f4b077/omnigrid-bootstrap.sh
                            | sudo bash
                        </div>
                        <p className="mt-3 text-xs text-slate-400">
                            This script installs Docker, joins omnigrid-net, and
